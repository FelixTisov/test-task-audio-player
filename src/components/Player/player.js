...
const Player = ({ URL, showInput }) => {
  ...
  const changeVolume = (e) => {
    ...
    volumeRange.current.style.setProperty(
      '--volume-offset',
      (volumeRange.current.value / volumeRange.current.max) * 100 + '%'
    )
  }
  ...
  return (
    <div className="player-container">
      ...
      <div className="player-container_back-button">
        <span
          onClick={handleBack}
          className="player-container_back-button-content"
        >
          ← Back
        </span>
      </div>
        ...
        <div className="player-container_wrapper">
          ...
          <div className="player-container_volume-control">
            <input
              ...
              max="100"
              defaultValue="50"
              className="player-container_volume-track"
            />
          </div>
        </div>
      </div>
